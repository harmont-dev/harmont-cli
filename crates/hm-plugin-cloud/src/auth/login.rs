...
async fn login_loopback(
    ...
    if webbrowser::open(&auth_url).is_err() {
        tracing::info!(target: "user::stderr", "couldn't auto-open the browser. Open this URL manually:\n  {auth_url}");
    }
...
async fn login_paste(
    ...
    tracing::info!(target: "user::stderr", "Open this URL in your browser, then paste the code:\n  {auth_url}");
