...
//!
//! Ported from atuin (`crates/atuin-common/src/string/ellipsis.rs`),
//! MIT-licensed. Upstream: <https://github.com/atuinsh/atuin>.
...
impl<'a> Ellipsized<'a> {
    const fn contiguous(text: &'a str, source_offset: usize) -> Self {
