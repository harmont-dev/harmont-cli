...
def test_none_policy_emits_no_key():
    graph = _make_graph(
        [
            {
                "step": {"key": "a", "eval": {"type": "cmd", "cmd": "echo"}, "cache": {"policy": "none"}},
                "env": {},
            },
        ]
    )
...
def test_parent_without_cache_is_planerror():
    graph = _make_graph(
        [
            {
                "step": {"key": "a", "eval": {"type": "cmd", "cmd": "x"}},
                "env": {},
            },
            {
                "step": {
